          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            >
              ...
              <div className="leading-tight">
                <span className="block text-[10px] text-gray-500">Delivering to {deliveryLocation}</span>
                <span className="block text-sm font-medium text-[#111]">Update location</span>
              </div>
            </button>
            ...
            <button type="button" className="hover:text-black text-gray-600 transition-colors relative group" aria-label="Wishlist" title="Wishlist">
              <Heart className="h-5 w-5 fill-transparent stroke-gray-500 group-hover:stroke-black group-hover:fill-red-500/20 transition-all duration-300" />
            </button>
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white px-4 pt-2 pb-4 space-y-4 border-t border-black/10 shadow-xl">
          <div className="flex flex-col space-y-2">
            ...
            <button className="block w-full text-left px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-black hover:bg-gray-100">
              Account &amp; Lists
            </button>
          </div>
        </div>
