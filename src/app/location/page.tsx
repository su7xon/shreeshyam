      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="aspect-video bg-gray-100 relative">
            <iframe
              src="https://maps.google.com/maps?q=Yash+Complex+Mohopada+Khalapur&t=&z=15&ie=UTF8&iwloc=&output=embed"
              width="100%"
              height="100%"
              style={{ border: 0 }}
              allowFullScreen
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <a href="tel:+919309415594" className="text-gray-900 font-medium hover:text-blue-600 transition-colors">
                  +91 93094 15594
                </a>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-gray-800 mb-1">Business Hours</p>
